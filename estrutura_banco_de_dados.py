...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:pBVa3L5zdmsJSxLT@db.quadjpyivoaqzwnikxuy.supabase.co:5432/postgres'
...
def inicializar_banco():
   with app.app_context(): # Executar o comando para criar o banco de dados
        db.drop_all()
        db.create_all()
